...
namespace jaut
{
     ...
     */
    class JAUT_API LogFormatXml : public ILogFormat
    {
    public:
         ...
         */
        explicit LogFormatXml(Options options);
    ...
    private:
        ...
        juce::String                      failedXml;
        
        //==============================================================================================================
        JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(LogFormatXml)
    };
}
