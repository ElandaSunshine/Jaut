...
/**
    The IThemeDefinition interface provides a collection of useful methods to implement your own
...
public:
     ...
     */
    virtual Image getImage(const String &imageName) const = 0;
    ...
    /**
        ...
        @return The image object
     */
    virtual Image getMissingImage() const = 0;
     ...
     */
    virtual Colour getThemeColour(const String &colorMappingKey) const = 0;
    ...
    /**
        ...
        @return The colour or a substitute if none such colour was found
     */
    virtual Colour getThemeColourFromPixel(int x, int y) const = 0;
     ...
     */
    virtual Font getThemeFont() const = 0;
    ...
    /**
        ...
        @return The image object
     */
    virtual Image getThemeThumbnail() const = 0;
     ...
     */
    virtual const bool isImageValid(const Image &image) const = 0;
     ...
     */
    virtual const String getImageExtension() const = 0;
     ...
     */
    virtual const String getThemeRootPath() const = 0;
